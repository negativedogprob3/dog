...
async def main():
    ...
    print_r("")
    print_r("🤖 AVAILABLE ROBOT COMMANDS:")
    print_r("=" * 60)
    print_r("")
    print_r("📦 BASIC POSES:")
    print_r("  • Stand up")
    print_r("  • Lie down / Stand down")
    print_r("  • Sit like a dog")
    print_r("  • Stretch like you're waking up")
    print_r("  • Shake your paw")
    print_r("  • Stop moving")
    print_r("")
    print_r("🎪 BIPEDAL & ACROBATIC POSES:")
    print_r("  • Stand on your hind legs")
    print_r("  • Do a handstand")
    print_r("  • Get into pounce position")
    print_r("")
    print_r("🚀 JUMPING & DYNAMIC MOVES:")
    print_r("  • Jump forward")
    print_r("  • Jump up")
    print_r("  • Do a front flip")
    print_r("  • Pounce like you're catching something")
    print_r("  • Bounce up and down")
    print_r("  • Hop around")
    print_r("")
    print_r("🎯 MOVEMENT COMMANDS:")
    print_r("  • Move forward / backward")
    print_r("  • Turn left / right")
    print_r("  • Walk in a circle")
    print_r("  • Move forward slowly / quickly")
    print_r("  • Turn 90 degrees left")
    print_r("  • Walk forward then turn right")
    print_r("")
    print_r("🎭 COMPLEX SEQUENCES:")
    print_r("  • Do pushups")
    print_r("  • Dance for me")
    print_r("  • Turn 180 degrees left, step forward, turn 45 degrees right")
    print_r("  • Stand up, do a handstand, then sit")
    print_r("  • Jump forward, do a front flip, then pounce")
    print_r("")
    print_r("📸 CAMERA:")
    print_r("  • Take a picture")
    print_r("  • Show me what you see")
    print_r("  • Capture the current view")
    print_r("")
    print_r("🧮 OTHER:")
    print_r("  • What's 2+2?")
    print_r("  • Run Python: print('Hello!')")
    print_r("  • What's your current status?")
    print_r("")
    print_r("💡 TIP: You can combine multiple actions!")
    print_r("    'Stand on hind legs, take a picture, then do a front flip'")
    print_r("")
